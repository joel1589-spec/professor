...
class SiteSettingAdmin(admin.ModelAdmin):
    ...
    fieldsets=((None, {'fields':('site_name','tagline','hero_title','hero_text','biography','profile_photo')}),('Contacts', {'fields':('phone','whatsapp','email','address')}))
...
class BookAdmin(admin.ModelAdmin):
    ...
    fieldsets=((None, {'fields':('title','slug','author','category','description','price','format')}),('Fichiers', {'fields':('cover','digital_file')}),('Publication', {'fields':('is_featured','is_active')}))
